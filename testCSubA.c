...
void default_spec(testargs *myargs, int **specptr)
{
  ...
  if (strlen(myargs->input0) == 0) strcpy(myargs->input0, "testCExtr/C");
...
void default_specA(testargs *myargs, int **specptr)
{
  ...
  if (strlen(myargs->input0) == 0) strcpy(myargs->input0, "testCExtr/CA");
...
void default_specR(testargs *myargs, int **specptr)
{
  ...
  if (strlen(myargs->input0) == 0) strcpy(myargs->input0, "testCExtr/CR");
...
void default_specS(testargs *myargs, int **specptr)
{
  ...
  if (strlen(myargs->input0) == 0) strcpy(myargs->input0, "testCExtr/CS");
...
void default_specB(testargs *myargs, int **specptr)
{
  ...
  if (strlen(myargs->input0) == 0) strcpy(myargs->input0, "testCExtr/CB");
...
int main(int argc, char * argv[])
{
  ...
  testerror = test_L_DA_loop(myargs, TYPE, specptr, run_CSubA);
  testerror |= test_L_DA_loop(&myargsA, TYPE, specptrA, run_CSubA);
  testerror |= test_L_DA_loop(&myargsR, TYPE, specptrR, run_CSubA);
  testerror |= test_L_DA_loop(&myargsS, TYPE, specptrS, run_CSubA);
  testerror |= test_L_DA_loop(&myargsB, TYPE, specptrB, run_CSubA);
