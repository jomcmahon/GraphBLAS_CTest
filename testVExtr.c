...
int main(int argc, char * argv[])
{
  ...
  testerror = test_L_DA_loop(myargs, TYPE, specptr, run_VExtr);
  testerror |= test_L_DA_loop(&myargsA, TYPE, specptrA, run_VExtr);
  testerror |= test_L_DA_loop(&myargsR, TYPE, specptrR, run_VExtr);
  testerror |= test_L_DA_loop(&myargsS, TYPE, specptrS, run_VExtr);
  testerror |= test_L_DA_loop(&myargsB, TYPE, specptrB, run_VExtr);
