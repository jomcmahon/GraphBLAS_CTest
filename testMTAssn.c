...
int main(int argc, char * argv[])
{
  ...
  testerror = test_L_DA_loop(myargs, TYPE, specptr, run_MTAssn);
  testerror |= test_L_DA_loop(&myargsA, TYPE, specptrA, run_MTAssn);
  testerror |= test_L_DA_loop(&myargsR, TYPE, specptrR, run_MTAssn);
  testerror |= test_L_DA_loop(&myargsS, TYPE, specptrS, run_MTAssn);
  testerror |= test_L_DA_loop(&myargsB, TYPE, specptrB, run_MTAssn);
