...
int main(int argc, char * argv[])
{
  ...
  TEST_OK(GxB_Type_size(&tsize, thetype)) ;
  SUBTEST_COND(tsize == sizeof(wildtype), "size not same user-defined");
  TEST_OK(GrB_Type_free(&thetype));
