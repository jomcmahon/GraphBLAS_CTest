...
int main(int argc, char * argv[])
{
  ...
  testerror = test_L_DA_loop(myargs, TYPE, specptr, run_MTSubA);
  testerror |= test_L_DA_loop(&myargsA, TYPE, specptrA, run_MTSubA);
  testerror |= test_L_DA_loop(&myargsR, TYPE, specptrR, run_MTSubA);
  testerror |= test_L_DA_loop(&myargsS, TYPE, specptrS, run_MTSubA);
  testerror |= test_L_DA_loop(&myargsB, TYPE, specptrB, run_MTSubA);
