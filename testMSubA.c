...
int main(int argc, char * argv[])
{
  ...
  testerror = test_L_DA_loop(myargs, TYPE, specptr, run_MSubA);
  testerror |= test_L_DA_loop(&myargsA, TYPE, specptrA, run_MSubA);
  testerror |= test_L_DA_loop(&myargsR, TYPE, specptrR, run_MSubA);
  testerror |= test_L_DA_loop(&myargsS, TYPE, specptrS, run_MSubA);
  testerror |= test_L_DA_loop(&myargsB, TYPE, specptrB, run_MSubA);
